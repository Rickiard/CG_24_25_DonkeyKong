...
function lançarBarril() {
    ...
    // Lógica para definir a posição de lançamento do barril conforme o nível
    if (window.gameState.currentLevel === 2) {
        // Nível 2: z sempre -3 (igual às plataformas do PlatformLevel2.js)
        novoBarril.position.set(-8.2, 6, -3);
    } else {
        // Nível 1: mantém lógica anterior
        novoBarril.position.set(-7, 5.25, barrilZPorPlataforma['8']);
    }
